...
public class AddResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, 110, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 490, 60));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 210, 150, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 260, 150, -1));
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, 150, -1));
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 340, 150, -1));
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 380, 150, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(!rs.first())
            {
                JOptionPane.showConfirmDialog(null, "Entered rollno is wrong");
            }
        }
        catch(Exception e)
        {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int compMarks=Integer.parseInt(jTextField5.getText());
        int engMarks=Integer.parseInt(jTextField6.getText());
        int result=0;
        result= physicsMarks+chemMarks+mathMarks+compMarks+engMarks;
        
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st= con.createStatement();
               st.executeUpdate("insert into result values(' "+ rollno+ " ', ' "+physicsMarks +" ', ' "+ chemMarks+" ', ' "+ mathMarks+" ', ' "+ compMarks+" ', ' "+ engMarks+" ', ' "+ result+ " ')");
